...
//
//
//import com.env.api.system.security.exception.NeedLoginException;
//import com.env.api.system.security.exception.NoAuthExcetion;
//import com.env.api.system.security.exception.WrongSpecialTokenException;
//import com.env.api.system.security.exception.WrongTokenExcetion;
//import com.env.service.system.SysUserService;
//import com.env.service.system.security.util.JwtTokenUtil;
...
//        List<String> list = sysUserService.queryAllUrlByUserId(userId);
//        if(null != list){
